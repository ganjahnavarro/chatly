...
class EditProductTypeModal extends PureComponent{
	...
	componentWillMount(){
		...
		selected.get('attributes').forEach(item => {
			attributes.push(item.get('attribute_id'))
		})
...
export default withRouter(connect(mapStateToProps)(EditProductTypeModal));
